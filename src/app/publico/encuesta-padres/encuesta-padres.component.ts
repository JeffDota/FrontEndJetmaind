...
export class EncuestaPadresComponent implements OnInit {
  ...
  recuperarDatosMarcas() {
    this.marcaService.getAllMarcasSinLimiteDesbloqueado().subscribe((resp: any) => {
  ...
  recuperarDatosPersonas() {
    this.personaService.getAllPersonasSinLimiteDesbloqueado().subscribe((resp: any) => {
  ...
  recuperarDatosEstudiantes() {
    this.estudiantesService.getAllEstudiantesSinLimiteDesbloqueado().subscribe((resp: any) => {
  ...
  crear() {
    ...
    this.encuestaService.crearencuesta(this.registerForm.value).subscribe((resp: any) => {
      ...
      setTimeout(() => {
        //this.router.navigateByUrl('https://corporacionjetmind.com/');
        //window.open('https://corporacionjetmind.com/', '_blank');
        window.location.href="https://corporacionjetmind.com/";
      }, 1000);
    });
  }

...
import { CalendarioCreacionTelemarketingComponent } from './calendario-creacion-telemarketing/calendario-creacion-telemarketing.component';
import { ListaCitasTresDiasComponent } from './citas-telemarketing/lista-citas-tres-dias/lista-citas-tres-dias.component';
import { ListaEstadoEstudianteComponent } from './estudiante/estado-estudiante/lista-estado-estudiante/lista-estado-estudiante.component';
import { CrearEvaluacionComponent } from './evaluacion-charlotte/crear-evaluacion/crear-evaluacion.component';
import { ListaEvaluacionCharlotteComponent } from './evaluacion-charlotte/lista-evaluacion-charlotte/lista-evaluacion-charlotte.component';
import { EncuestaPadresReporteComponent } from './encuesta-padres-reporte/encuesta-padres-reporte.component';
import { VistaDirectoresComponent } from './contrato/vista-directores/vista-directores.component';
import { ReporteEntrevistaSinObservacionesComponent } from './entrevista-inicial-tm/reporte-entrevista-sin-observaciones/reporte-entrevista-sin-observaciones.component';
...
const routes: Routes = [
    /**Rutas protegidas */
    {
        ...
        children: [
            ...
            { path: 'lista-historial-estudiantes', canActivate:[AclGuard], component: ListaEstadoEstudianteComponent, data: { titulo: 'Historial Estudiantes' } },
            ...
            { path: 'reporte-venta-contrato', canActivate:[AclGuard], component: ReporteVentasContratoComponent, data: { titulo: 'Reporte ventas' } },
            { path: 'listacontratos-directores', canActivate:[AclGuard], component: VistaDirectoresComponent, data: { titulo: 'Lista de los contratos' } },
            ...
            { path: 'calendario', canActivate:[AclGuard], component: CalendarioComponent, data: { titulo: 'Calendario Fecha de agendamiento de citas' } },
            { path: 'calendario-creacion', canActivate:[AclGuard], component: CalendarioCreacionTelemarketingComponent, data: { titulo: 'Calendario Creacion de citas' } },
            { path: 'listacitastresdias', canActivate:[AclGuard], component: ListaCitasTresDiasComponent, data: { titulo: 'Lista de citas de los proximos tres dias' } },
            ...
            { path: 'encuesta-padres-reporte', canActivate:[AclGuard], component: EncuestaPadresReporteComponent, data: { titulo: 'Reporte' } },
            ...
            { path: 'reporte-entrevistainicialtm-sin-comentario/:id', canActivate:[AclGuard], component: ReporteEntrevistaSinObservacionesComponent, data: { titulo: 'Entrevista IL' } },
            ...
            { path: 'evaluacion-charlotte-unico/:id', canActivate:[AclGuard], component: CrearEvaluacionComponent, data: { titulo: 'Evaluacion Charlotte' } },
            { path: 'lista-evaluacion-charlotte', component: ListaEvaluacionCharlotteComponent , data:{titulo:'Lista Evaluacion Charlotte'} },

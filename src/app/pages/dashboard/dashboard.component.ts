...
export class DashboardComponent implements OnInit {
  ...
  constructor(
    ...
    this.vigenciaService.getAllVigencias().subscribe(((resp:any)=>{
      let fechaInicio:any = new Date(resp.data[0].fechaInicio) ;
      let fechaCierre:any = new Date(resp.data[0].fechaCierre) ;
      this.vigencia = (fechaCierre.getTime() - fechaInicio.getTime())/1000;
    }));
  }

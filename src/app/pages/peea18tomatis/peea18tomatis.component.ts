...
export class Peea18tomatisComponent implements OnInit {
  ...
  cargarEstudianteContrato(idContrato: any) {
    this.contratoService.obtenerContratoByIdDesbloqueado(idContrato).subscribe((resp: any) => {
      this.estudianteService.getAllEstudiantesByIdRepresentanteDesbloqueado(resp.data.idRepresentante).subscribe((resp: any) => {
  ...
  crearPeea18() {
    if (this.pea18tomatisSeleccionada) {
      ...
      if (this.registerForm.invalid) {
        ...
        this.contratoService.obtenerContratoByIdDesbloqueado(this.Peea18tomatisModel.idContrato).subscribe((resp: any) => {
          let datos = resp.data;
          if (datos.pea) {
          ...
          this.contratoService.updatecontratoSinNotificacionDesbloqueado(this.Peea18tomatisModel.idContrato, datos).subscribe((resp: any) => {
            console.log(resp);
          });
        });

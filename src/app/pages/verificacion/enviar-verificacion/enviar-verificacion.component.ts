...
export class EnviarVerificacionComponent implements OnInit {
  ...
  cargarVerificacionbyId(id: string) {
    ...
    this.verificacionService.obtenerVerificacionByIdDesbloqueada(id)
      .subscribe((resp: any) => {
        ...
        this.representanteService.obtenerRepresentanteByIdDesbloqueado(this.verificacionesSeleccionadas.idContrato[0].idRepresentante)
          .subscribe((resp: any) => {
            console.log(resp.data);
  ...
  aceptarVerificacion() {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        this.verificacionService.updateVerificacionDesbloqueada(this.verificacionesSeleccionadas._id, this.verificacionesSeleccionadas).subscribe((resp: any) => {
          this.cargarVerificacionbyId(this.verificacionesSeleccionadas._id);
        }
        );

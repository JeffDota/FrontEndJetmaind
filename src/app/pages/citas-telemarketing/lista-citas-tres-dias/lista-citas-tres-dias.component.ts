...
@Component({
  selector: 'app-lista-citas-tres-dias',
  templateUrl: './lista-citas-tres-dias.component.html',
  styleUrls: ['./lista-citas-tres-dias.component.css']
})
export class ListaCitasTresDiasComponent implements OnInit {
  ...
  cargarCitas() {
    this.cargando = true;
    this.citasTelemarketingService.cargarCitasTelemarketing3Dias(this.desde).subscribe((resp: any) => {
      console.log(resp);
      this.cargando = false;

  ...
  crearPeea17() {
    if (this.pea17tomatisSeleccionada) {
      ...
      if (this.registerForm.invalid) {
        ...
        this.contratoService.obtenerContratoByIdDesbloqueado(this.Peea17tomatisModel.idContrato).subscribe((resp: any) => {
          let datos = resp.data;
          if (datos.pea) {
          ...
          this.contratoService.updatecontratoSinNotificacionDesbloqueado(this.Peea17tomatisModel.idContrato,datos).subscribe((resp: any) => {
            console.log(resp);
          });
        });

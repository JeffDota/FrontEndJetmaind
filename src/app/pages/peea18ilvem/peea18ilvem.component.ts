  ...
  crearPeea18() {
    if (this.pea18ilvemSeleccionada) {
      ...
      if (this.registerForm.invalid) {
        ...
        this.contratoService.obtenerContratoByIdDesbloqueado(this.Peea18ilvemModel.idContrato).subscribe((resp: any) => {
          let datos = resp.data;
          if (datos.pea) {
          ...
          this.contratoService.updatecontratoSinNotificacionDesbloqueado(this.Peea18ilvemModel.idContrato, datos).subscribe((resp: any) => {
            console.log(resp);
          });
        });

...
export class ListaPersonasComponent implements OnInit {
  ...
  reenviarCorreoPersona(){
    this.personaService.reeviarCorreo(this.personaSeleccionado._id).subscribe(resp => {
      Swal.fire(
        'Correo reenviado!',
  ...
  actualizarEstado(persona: any) {
    if (persona.estado == 'Activo') {
      persona.estado = 'Inactivo';
    } else {
      persona.estado = 'Activo';
    }
    this.personaService.updatePersona(persona._id, persona).subscribe(resp => {
      Swal.fire(
        'Actualizado!',

...
export class PersonaComponent implements OnInit {
  ...
  async crearPersona() {
    if (this.personaSeleccionada) {
      ...
      this.PersonaModel.telefono = this.registerForm.value.telefono.e164Number;

      if (this.PersonaModel.estado) {
        this.PersonaModel.estado = 'Activo';
      } else {
        this.PersonaModel.estado = 'Inactivo';
      }

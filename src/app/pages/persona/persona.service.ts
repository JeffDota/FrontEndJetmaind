...
export class PersonaService {
  ...
  getAllPersonasSinLimiteDesbloqueado() {
    const headers = this.retornarHeader();
    return this.http.get(`${base_url}/persona/allDesbloqueado`, { headers: headers });
  }
  ...
  //Persona por Ciudad y marca
  getAllByRoleCiudadMarca2() {
    const headers = this.retornarHeader();
    return this.http.get(`${base_url}/persona/allByCiudadMarca`, { headers: headers });
  }
  ...
  reeviarCorreo(idPersona:string){
    const headers = this.retornarHeader();
    return this.http.get(`${base_url}/persona/reenviar-correo/${idPersona}`,{ headers: headers });
  }
  ...
  obtenerPersonaByIdSinAuth(id:string){
    const headers = this.retornarHeader();
    return this.http.get(`${base_url}/persona/sinAuth/${id}`, { headers: headers })
  }
  ...
  updatePersonaSinAuth(id:string, persona:Persona){
    const headers = this.retornarHeader();
    return this.http.put(`${base_url}/persona/sinAuth/${id}`, persona, { headers: headers });
  }

...
@Component({
  selector: 'app-vista-directores',
  templateUrl: './vista-directores.component.html',
  styleUrls: ['./vista-directores.component.css']
})
export class VistaDirectoresComponent implements OnInit {
  ...
  cargarContratos() {
    this.cargando = true;
    this.contratoService.cargarContratosDirectores(this.desde).subscribe((resp: any) => {
      this.cargando = false;

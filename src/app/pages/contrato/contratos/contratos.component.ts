...
export class ContratosComponent implements OnInit {
  ...
  public dropdownSettingsMarca: IDropdownSettings = {};
  ...
  public mostraModalMarcasVendidas: boolean = true;
  ...
  mostrarDatosModal(contrato: any) {
    ...
    this.marcasVendidas = contrato.marcasVendidas;
    this.imageObject = [];
  ...
  cerrarModalMarcasVendidas() {
    this.mostraModalMarcasVendidas = true;
  }

  crearMarcasVendidas() {
    //actualizar contrato con las marcas seleccionadas
    this.contratoSeleccionado.marcasVendidas = this.marcasVendidas;
    this.contratoService.updatecontrato(this.contratoSeleccionado._id,this.contratoSeleccionado).subscribe((resp: any) => {
      console.log('Actualizado MARCAS',resp);
      this.crearMarcasVendidas();
      this.cerrarModal();
    });
  }

  abrirModalMarcasVendidas() {
    this.mostraModalMarcasVendidas = false;
  }

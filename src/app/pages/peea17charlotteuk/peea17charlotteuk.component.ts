      ...
      if (this.registerForm.invalid) {
        ...
        setTimeout(() => {
          this.peea17chukService.crearPeea17chuk(this.Peea17chukModel).subscribe((resp) => {
            ...
            this.contratoService.obtenerContratoByIdDesbloqueado(this.Peea17chukModel.idContrato).subscribe((resp: any) => {
              let datos = resp.data;
              if (datos.pea) {
              ...
              this.contratoService.updatecontratoSinNotificacionDesbloqueado(this.Peea17chukModel.idContrato,datos).subscribe((resp: any) => {
                console.log(resp);
              });
            });

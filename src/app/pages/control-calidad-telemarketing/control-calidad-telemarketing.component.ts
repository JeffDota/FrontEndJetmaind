  ...
  crear() {
    ...
    if (this.controlCalidadTelemarketingSeleccionada) {
      ...
      if (this.registerForm.invalid) {
        ...
        if (this.ControlCalidadtelemarketingModel.estado.nombre == 'Re agendado' || this.ControlCalidadtelemarketingModel.estado.nombre == 'Cliente no atendido') {
          this.citasTelemarketingService.obtenerCitasTelemarketingById(this.citasTelemarketing).subscribe((resp: any) => {
            ...
            this.datosTelemarketing.estado = this.ControlCalidadtelemarketingModel.estado.nombre;

...
@Component({
  selector: 'app-asistencia-tomatis',
  templateUrl: './asistencia-tomatis.component.html',
  styles: [
  ]
})
export class AsistenciaTomatisComponent implements OnInit {
  ...
  public registerForm = this.fb.group({
    ...
    prueba: this.fb.array([this.fb.group({ estado: [null], estudiante: [null], idEstudiante: [null], comentario: [null], _id: [null], fase: [null] })]),
  });
  ...
  recuperarDatosHorarios() {
    this.horariosService.obtenerHorarioallbyCiudadMarcaEstado().subscribe((resp: any) => {

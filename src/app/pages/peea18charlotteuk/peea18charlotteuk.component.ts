  ...
  crearPeea18() {
    ...
    if (this.pea18chukSeleccionada) {
      ...
      if (this.registerForm.invalid) {
        ...
        this.contratoService.obtenerContratoByIdDesbloqueado(this.Peea18chukModel.idContrato).subscribe((resp: any) => {
          let datos = resp.data;
          if (datos.pea) {
          ...
          this.contratoService.updatecontratoSinNotificacionDesbloqueado(this.Peea18chukModel.idContrato, datos).subscribe((resp: any) => {
            console.log(resp);
          });
        });

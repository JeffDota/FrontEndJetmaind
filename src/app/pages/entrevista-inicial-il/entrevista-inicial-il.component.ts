...
@Component({
  ...
  templateUrl: './entrevista-inicial-il.component.html',
  styles: [
  ]
})
export class EntrevistaInicialILComponent implements OnInit {
  ...
  constructor(
    ...
    private entrevistaInicialILService: entrevistainicialilvemService,
    ...
    if (this.registerForm.invalid) {
      ...
      this.entrevistaInicialILService.crearEntrevista(this.entrevistaInialCHUKModel).subscribe((resp) => {
        ...
        this.contratoService.obtenerContratoById(this.entrevistaInialCHUKModel.idContrato).subscribe((resp: any) => {
          ...
          setTimeout(() => {
            this.contratoService.updatecontratoSinNotificacion(this.entrevistaInialCHUKModel.idContrato, datos).subscribe((resp: any) => {
              console.log(resp);
            });
          }, 100);

...
@Component({
  selector: 'app-reporte-entrevista-sin-observaciones',
  templateUrl: './reporte-entrevista-sin-observaciones.component.html',
  styleUrls: ['./reporte-entrevista-sin-observaciones.component.css']
})
export class ReporteEntrevistaSinObservacionesComponent implements OnInit {
  ...
  createPDF(estudiante: any, representante: any, contrato: any, entrevista: any) {
    ...
    entrevista.estudiantes1.map((resp: any) => {
      this.estudianteService.obtenerEstudianteById(resp.estudiantes[0].idEstudainte).subscribe((resp2: any) => {
        ...
        asuntosTratados.push([resp.estudiantes[0].nombreEstudiante, resp.pregunta1, resp.pregunta2]);
      });

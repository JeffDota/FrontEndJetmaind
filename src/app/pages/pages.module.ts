...
@NgModule({
  declarations: [
    ...
    CalendarioCreacionTelemarketingComponent,
    ListaCitasTresDiasComponent,
    ListaEstadoEstudianteComponent,
    CrearEvaluacionComponent,
    ListaEvaluacionCharlotteComponent,
    EncuestaPadresReporteComponent,
    VistaDirectoresComponent,
    ReporteEntrevistaSinObservacionesComponent,

...
export class EvaluacionCharlotteService {
  ...
  getAllevaluacioncharlotteByIdEstudiante(idEstudiante:any){
    const headers = this.retornarHeader();
    return this.http.get(`${base_url}/evaluacion-charlotte/AllByIdEstudiante/${idEstudiante}`, { headers: headers });
  }

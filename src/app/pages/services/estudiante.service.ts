...
export class EstudianteService {
  ...
  getAllEstudiantesSinLimiteDesbloqueado() {
    const headers = this.retornarHeader();
    return this.http.get(`${base_url}/estudiante/allDesbloqueado`, { headers: headers });
  }
  
  getAllEstudiantesallSinEstado() {
    const headers = this.retornarHeader();
    return this.http.get(`${base_url}/estudiante/allSinEstado`, { headers: headers });
  }
  ...
  getAllEstudiantesByIdRepresentanteDesbloqueado(idRepresentante: string) {
    const headers = this.retornarHeader();
    return this.http.get(`${base_url}/estudiante/desbloqueado/representante/${idRepresentante}`, { headers: headers });
  }

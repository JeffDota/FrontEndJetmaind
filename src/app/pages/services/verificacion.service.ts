...
export class VerificacionService {
  ...
  obtenerVerificacionByIdDesbloqueada(id: string) {
    const headers = this.retornarHeader();
    return this.http.get(`${base_url}/verificacion/desbloqueada/${id}`, { headers: headers })
  }
  ...
  updateVerificacionDesbloqueada(id: string, verificacion: Verificacion) {
    const headers = this.retornarHeader();
    return this.http.put(`${base_url}/verificacion/desbloqueada/${id}`, verificacion, { headers: headers });
  }
